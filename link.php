...
<body>
  <main>
    ...
    <section class="main-section" style="letter-spacing: 1px;">
      <div class="title" style="letter-spacing: 1px; font-weight:600">
      ...
      <div class=" form-container">
        <form action="" method="post">
          <div class="form-field" style="display: flex; gap: 10px; align-items: center;">
            ...
            <div class="input-div" style="width: 70%; margin-left: 18px">
          ...
          <div class="form-field" style="display: flex; gap: 10px; justify-content:space-between; align-items: center;">
            <label for="">Generated Link:</label>
            <span class=""></span>
            <div class="copy-btn" style="display: flex; justify-content: flex-end; width: 50%">
              <button type="button" style=" padding: .2em .6em; font-size: .8999rem">Copy Link</button>
            </div>
          </div>
